	                ...
	                <div class="row pt-3">
	                    <div class="col">
	                        ...
	                        <div class="form-group">
								...
								<small id="short-biography-help" class="form-text text-muted hide">Max 255 characters. Any additional characters will be stripped. <span data-target="bio-current-chars">0/255 characters</span></small>
	                        </div>
	                        <div class="form-group">
	                            <label for="profile-long-biography">Long Biography</label>
	                            <textarea style="resize: none" id="profile-long-biography" class="form-control textarea-long-biography" rows="3" disabled></textarea>
	                        </div>
	                    </div>
	                </div>
