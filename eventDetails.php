...
<html lang="en" dir="ltr">
            ...
            <form class="needs-validation" id="details-form" novalidate>
                ...
                <div class="row">
                    <div class="col text-right">
                        <button type="submit" class="btn btn-secondary mb-2">UPLOAD COVER IMAGE</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col text-right">
                        <button type="submit" class="btn btn-secondary mb-2">UPLOAD PRESENTATION</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-right">
                        <button type="submit" class="btn btn-warning mb-2" data-target="save-details">SAVE</button>
                        <button type="submit" class="btn btn-dark mb-2">CANCEL</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <footer>
        ...
        <script src="eventDetails.js" type="text/javascript">
