...
<head> <!-- initialise page and import bootstrap stylesheet -->
    ...
    <link rel="stylesheet" type="text/css" href="indexSS.css"> <!-- import specific page stylesheet -->
</head>
<body>
    ...
    <div class="banner"></div> <!-- div block for page structure -->
    <div class="content"> <!-- Main content goes here -->
        <div class="container"> <!-- bootstrap container used (not container-fluid as that is full page width) -->
            <div class="row"> 
                <div class="col-xs-0 col-sm-0 col-md-2"> <!-- col used to help center login form (cols are removed at certain page size) -->
                    <div class="blackspace"></div> <!-- div block for page structure -->
                </div>
                <div class="col">
                    ...
                    <form action='login.php' method='post' id="loginform"> <!-- login form created that is linked to the login.php file -->
                        ...
                        <div class="form-group"> <!-- (bootstrap class used) -->
                            <label for="eventref" class="labelstyle">Event Reference</label>
                        ...
                        <button type='submit' class="btn btn-primary" id='formbutton'>Login</button> <!-- login button (bootstrap class used) -->
                    </form>
                </div>
